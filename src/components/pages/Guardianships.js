    ...
    return (
        <div>
            <div>
                ...
                <div className="ui">
                <h2 id="guardianships-banner" className="ui center aligned container">Special Needs Trusts And Medicaid Planning</h2>
            </div>
            </div>
            <div className="ui" id="guardianships-text-content">
                <p className="b">
