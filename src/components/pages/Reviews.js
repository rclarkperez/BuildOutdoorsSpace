...
const Reviews = () => {
    ...
    const reviewList = [
        ...
        {
            review: 'Professional and efficient service for our commercial excavation needs!',
            reviewer: 'David Johnson',
        },
        {
            review: 'Highly skilled team for our residential excavation project. Great job!',
            reviewer: 'Sarah Williams',
        },
        {
            review: 'Exemplary work on our excavation. Timely and precise. Highly recommended!',
